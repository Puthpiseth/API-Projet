...
// creer AlartBox
 ...
 let AlartClose = document.querySelector('.form-box p:first-child')
 AlartClose.textContent="x"
 AlartClose.style.transform="translateY(-50px)"
 console.log(AlartClose)
    ...
    .then (function(response){ //Function pour virefier le reponse de le requit avec le data de le utilisateur
        ...
        AlertBox.style.display="block"
           ...
           response.json().then((data) => {//stocker le data de l'utilisateur et entrer dans le home page
            ...
            AlertBox.style.display="none"
            window.location.href=("/home/simplon/Pictures/API-Projet/home.html")
           })
